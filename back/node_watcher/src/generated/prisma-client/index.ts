...
export interface Prisma {
  ...
  treasury: (where: TreasuryWhereUniqueInput) => TreasuryNullablePromise;
  treasuries: (args?: {
    where?: TreasuryWhereInput;
    orderBy?: TreasuryOrderByInput;
    skip?: Int;
    after?: String;
    before?: String;
    first?: Int;
    last?: Int;
  }) => FragmentableArray<Treasury>;
  treasuriesConnection: (args?: {
    where?: TreasuryWhereInput;
    orderBy?: TreasuryOrderByInput;
    skip?: Int;
    after?: String;
  ...
  createTreasury: (data: TreasuryCreateInput) => TreasuryPromise;
  updateTreasury: (args: {
    data: TreasuryUpdateInput;
    where: TreasuryWhereUniqueInput;
  }) => TreasuryPromise;
  updateManyTreasuries: (args: {
    data: TreasuryUpdateManyMutationInput;
    where?: TreasuryWhereInput;
  }) => BatchPayloadPromise;
  upsertTreasury: (args: {
    where: TreasuryWhereUniqueInput;
    create: TreasuryCreateInput;
    update: TreasuryUpdateInput;
  }) => TreasuryPromise;
...
export interface TreasurySubscriptionWhereInput {
  mutation_in?: Maybe<MutationType[] | MutationType>;
  updatedFields_contains?: Maybe<String>;
  updatedFields_contains_every?: Maybe<String[] | String>;
  updatedFields_contains_some?: Maybe<String[] | String>;
  node?: Maybe<TreasuryWhereInput>;
  AND?: Maybe<
...
export interface TreasuryConnectionPromise
  extends Promise<TreasuryConnection>,
    Fragmentable {
  pageInfo: <T = PageInfoPromise>() => T;
  edges: <T = FragmentableArray<TreasuryEdge>>() => T;
  aggregate: <T = AggregateTreasuryPromise>() => T;
}

export interface TreasuryConnectionSubscription
  extends Promise<AsyncIterator<TreasuryConnection>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
  edges: <T = Promise<AsyncIterator<TreasuryEdgeSubscription>>>() => T;
  aggregate: <T = AggregateTreasurySubscription>() => T;
}

export interface TreasuryEdge {
  node: Treasury;
  cursor: String;
}

export interface TreasuryEdgePromise
  extends Promise<TreasuryEdge>,
    Fragmentable {
  node: <T = TreasuryPromise>() => T;
  cursor: () => Promise<String>;
}

export interface TreasuryEdgeSubscription
  extends Promise<AsyncIterator<TreasuryEdge>>,
    Fragmentable {
  node: <T = TreasurySubscription>() => T;
  cursor: () => Promise<AsyncIterator<String>>;
}

export interface AggregateTreasury {
  count: Int;
}

export interface AggregateTreasuryPromise
  extends Promise<AggregateTreasury>,
    Fragmentable {
  count: () => Promise<Int>;
}
...
export interface TreasurySubscriptionPayload {
  mutation: MutationType;
  node: Treasury;
  updatedFields: String[];
  previousValues: TreasuryPreviousValues;
}

export interface TreasurySubscriptionPayloadPromise
  extends Promise<TreasurySubscriptionPayload>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = TreasuryPromise>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = TreasuryPreviousValuesPromise>() => T;
}

export interface TreasurySubscriptionPayloadSubscription
  extends Promise<AsyncIterator<TreasurySubscriptionPayload>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
  node: <T = TreasurySubscription>() => T;
  updatedFields: () => Promise<AsyncIterator<String[]>>;
  previousValues: <T = TreasuryPreviousValuesSubscription>() => T;
}
